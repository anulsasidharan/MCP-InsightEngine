...
uploaded_file = st.file_uploader("Upload your Excel/PDF/CSV file.", type=["pdf", "csv", "xlsx", "xls"])

if uploaded_file:
    # If file uploaded, save the file to the "assets/uploads" directory
    ...
    if uploaded_file.name.endswith(".csv"):
        ...
        st.text_area("Text Extracted form PDF:", pdf_text[:5000], height=300)
        
        if st.button("Generate insights form pdf"):
